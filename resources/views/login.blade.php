...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <p class="auth-subtitle">Enter your email and password to access your account and manage your services.</p>
        ...
        <form action="/login" method="POST">
            ...
            <p class="switch-link">Don't have an account? <a href="{{ route('register') }}">Sign Up Here</a></p>
